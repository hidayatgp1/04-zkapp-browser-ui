...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [Hidayatgp1]</title>
        <meta name="description" content="ZkApp By Hidayatgp1" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/hidayatgp1" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/1029016956579369010" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>

				<a style={{display: 'block'}} href="https://twitter.com/hidayatgp1_sv" target="_blank" rel="noopener noreferrer" >
						<span className={styles.twIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/hidayatgp1" target="_blank" rel="noopener noreferrer" >
